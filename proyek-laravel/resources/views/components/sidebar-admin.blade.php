...
<img src="assets/images/foto-cewe.png" class="rounded-circle img-thumbnail" alt="" style="object-fit: cover; width:10rem; height:10rem">
  <div class="card-body">
    ...
    <p><a href="/pesanan-admin" class="text-decoration-none text-white fs-5 {{ request()->is('pesanan-admin*') ? 'active' : '' }}">Pesanan</a></p>
    <p><a href="/produk-admin" class="text-decoration-none text-white fs-5 {{ request()->is('produk-admin*') ? 'active' : '' }}">Produk</a></p>
    <p><a href="/seting-admin" class="text-decoration-none text-white fs-5 {{ request()->is('seting-admin*') ? 'active' : '' }}">Seting</a></p>
