    ...
    <div class="row text-justify">
        ...
        <div class="col-4 position-relative ms-5">
            ...
            <div class="card position-absolute top-0 start-5 border border-5 border-white" style="width: 22rem; height: 20rem; transform: rotate(-8.65deg);">
                <img src="/assets/images/fotoba.png" class="card-img-top" alt="..." style="width: 100%; height: 100%; object-fit: cover;">
            </div>
        </div>
        <div class="col-6 text-justify">
            <h2 class="fw-semibold fs-1">Flo Beauty Bar</h2>
            <p class="fs-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Similique sunt, est pariatur illo odit laudantium exercitationem architecto delectus doloremque nostrum, animi odio ut aut obcaecati beatae, incidunt sequi? Expedita beatae itaque enim consectetur perferendis ullam vero, id aperiam magni aliquam dolores sunt maiores? Nostrum accusamus numquam aliquam nisi quos enim.</p>
        </div>
    </div>
</div>
