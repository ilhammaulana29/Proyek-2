...
<div class="kontak-kami text-white">
        ...
        <div class="col-4 mx-auto">
            ...
            <div class="info">
                ...
                <div class="email d-flex align-items-center">
                    ...
                    <p class="ms-2 fs-5 m-auto">flobeautybar@gmail.com</p>
                </div>
                <div class="lokasi d-flex align-items-center">
                    <i class="bi bi-geo-alt fs-1"></i>
                    <p class="ms-2 fs-5 m-auto">Ds. Kertawinangun, Kec. Kandanghaur, Kab. Indramayu</p>
                </div>
            </div>
        </div>
        <div class="col-4 mx-auto">
